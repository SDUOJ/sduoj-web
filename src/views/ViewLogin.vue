    ...
    <div class="login-container">
        <el-form ref="loginForm" :model="loginForm" class="login-form" label-position="left" :rules="loginRules">
            ...
            <el-form-item prop="username">
                ...
                <el-input v-model="loginForm.username" name="username" type="text" placeholder="在此输入用户名" />
            </el-form-item>
            <el-form-item prop="password" ref="passwordForm">
                <span class="svg-container"> <v-icon name="key" /> </span>
                <el-input :type="pwdType" v-model="loginForm.password" name="password" placeholder="在此输入密码" @keyup.enter.native="handleLogin" />
